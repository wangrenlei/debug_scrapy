...
class CrawlerRunner(object):
    ...
    def __init__(self, settings=None):
        ...
        self.spider_loader = _get_spider_loader(settings)       #根据配置加载spider（划重点！！！）
        self._crawlers = set()
        self._active = set()
...
def _get_spider_loader(settings):
    ...
    # 使用SPIDER_LOADER_CLASS替代SPIDER_MANAGER_CLASS
    ...
    # 校验spider_loader/spider_manager类和接口ISpiderLoader的实现关系，由于spider_manager已经废弃，所以有些接口方法可能未实现
    # 所以建议添加缺失的方法或者直接替换成spider_loader
    try:
